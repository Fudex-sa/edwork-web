...
<input type="hidden" id="anPageName" name="page" value="startuphubkhobar" />
    <div className="startuphubkhobar anima-screen">
      ...
      <div className="u0645u0631-u0627u0644-C61RwL font-class-1">
        <span className="span1-xuncO9">مرحبا بكم في صفحة الوظائف لمجمع ريادة الأعمال بالخبر<br /></span>
        <span className="span2-xuncO9"
          >يعد مجمع ريادة الأعمال في الخبر أول مجمع ريادة أعمال متكامل في المملكه لتحفيز رواد الأعمال لبدء نشاطهم
          التجاري ومواجهة التحديات لتحقيق النجاح والإستدامة. <br /><br />يمكنكم من خلال هذه الصفحة الإطلاع على الوظائف
          الشاغرة لدى المجمع و أعضاء المجمع أدناه</span
        >
        <span className="span3-xuncO9"><br /></span>
        <span className="span4-xuncO9"
          >إعلان إخلاء مسؤولية: الوظائف المعروضة من قبل الأعضاء هي مسؤوليتهم الخاصة والمجمع غير مسؤول عن أي خلاف بين
          المتقدم وعارض الوظيفة.<br
        /></span>
      </div>
      <div className="anima-container-center-horizontal">
    ...
    <div className="startuphubkhobar2 anima-screen">
      ...
      <div className="u0645u0631-u0627u0644-C61RwL font-class-1">
        <span className="span1-xuncO9">مرحبا بكم في صفحة الوظائف لمجمع ريادة الأعمال بالخبر</span>
        <span className="span2-xuncO9"><br /></span>
        <span className="span3-xuncO9"
          >يعد مجمع ريادة الأعمال في الخبر أول مجمع ريادة أعمال متكامل في المملكه لتحفيز رواد الأعمال لبدء نشاطهم
          التجاري ومواجهة التحديات لتحقيق النجاح والإستدامة. <br /><br />يمكنكم من خلال هذه الصفحة الإطلاع على الوظائف
          الشاغرة لدى المجمع و أعضاء المجمع أدناه</span
        >
        <span className="span4-xuncO9"><br /></span>
        <span className="span5-xuncO9"
          >إعلان إخلاء مسؤولية: الوظائف المعروضة من قبل الأعضاء هي مسؤوليتهم الخاصة والمجمع غير مسؤول عن أي خلاف بين
          المتقدم وعارض الوظيفة.</span
        >
        <span className="span6-xuncO9"><br /></span>
      </div>
    </div>
    ...
    <div className="startuphubkhobar22 anima-screen">
