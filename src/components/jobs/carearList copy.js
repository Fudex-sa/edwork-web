        ...
        >
          <div style={{ display: "flex", flexDirection: "row" }}>
            ...
            >
              ...
              <span style={{}}>{job.Addresses && job.Addresses.length && job.Addresses[0].Governorate > 0 ? job.Addresses[0].Governorate.name.en : "Not set"}</span>
            </div>
            <div
              style={{
                display: "flex",
...
<a  className="item text-right" onClick={() => this.setModal(false)}
style={{color:'#CCC'}}>
  <i class="fa fa-times-circle fa-2x" aria-hidden="true"></i>
</a>
<span style={{ fontSize: "18px",fontWeight:'bold',marginBottom:'20px',marginTop:'10px' }}>{job.title}</span>
<div
              style={{
                display: "flex",
                flexDirection: "column",
          ...
          color: "#FFF",}}
            ...
            >
              ...
              <span>{job.Addresses && job.Addresses.length && job.Addresses[0].Governorate > 0 ? job.Addresses[0].Governorate.name.en : "Not set"}</span>
            </div>
            <div
              style={{
                display: "flex",
...
export default connect((state) => state, mapDispatchToProps)(withNamespaces()(carearList));
